...
> Production-ready agentic workflow building blocks: **95 plugins**, **202 agents**,
...
| | Count | What it is |
|---|---:|---|
| **Plugins** | 95 | Granular, single-purpose installable units (93 local + 2 external via git-subdir) |
